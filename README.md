...
**Important:** 3DMilling, Mill5Axis, and VSPMillSAxis are **not licensed** on the current HOPS dongle (ID: [REDACTED]). The machine (7535) supports 5-axis mechanically, but HOPS cannot simulate or verify 5-axis paths. All operations in this plugin are 2.5D (XY movement + vertical Z plunge).
